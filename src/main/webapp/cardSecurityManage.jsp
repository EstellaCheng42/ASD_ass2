<%-- 
    Document   : cardSecurityManage
    Created on : 2021-10-5, 7:31:39
    Author     : chengming
--%>
...
<html>
    ...
    <body>
<%-- 
 using getAttribute to get the object and store in the cardlist object.
--%>
        <%
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="deleteCardServlet?cardId=<%= opalcard.getCardId()%>" class="btn btn-sm btn-secondary">Block</a></td>
                    </tr>
                    <%}%>
                </tbody>
            </table>
